  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      let tHero = gsap.context(() => {
        ...
        let split_hero__title_2 = new SplitText(heroTitle_2.current, {
          type: "chars",
        });
        ...
        gsap.from(split_hero__title_2.chars, {
          duration: 1,
          x: 70,
          autoAlpha: 0,
          stagger: 0.1,
            ...
            <div className="col-xxl-12">
              <div className="hero__content animation__hero_one">
                ...
                <div className="hero__title-wrapper">
                  ...
                  <h1 className="hero__title-2" ref={heroTitle_2}>
                    AGENCY
                  </h1>
