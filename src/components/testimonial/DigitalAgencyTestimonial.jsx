...
import Testimonial12 from "../../../public/assets/imgs/testimonial/1/2.jpg";
import Testimonial13 from "../../../public/assets/imgs/testimonial/1/3.jpeg";
            ...
            <div className="col-xxl-8 col-xl-8 col-lg-8 col-md-8">
              <div className="testimonial__wrapper">
                <div className="testimonial__item item-1">
                  <div className="button modal-trigger" ref={modalTrigger1}>
                    ...
                    <h2 className="testimonial__title">Gary Guinta</h2>
              ...
              <div className="testimonial__item item-2">
                <div className="button modal-trigger-2" ref={modalTrigger2}>
                  ...
                  <h2 className="testimonial__title">Idriss Tamni</h2>
                  <h3 className="testimonial__role">CEO & Founder of Casavona</h3>
                </div>
              </div>
            </div>
            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-4">
              <div className="testimonial__item item-3 img-">
                <div className="button modal-trigger-3" ref={modalTrigger3}>
                  ...
                  <h2 className="testimonial__title">Adam Louis</h2>
                  <h3 className="testimonial__role">CEO & Founder of Albert</h3>
                </div>
              </div>
            </div>
          </div>
